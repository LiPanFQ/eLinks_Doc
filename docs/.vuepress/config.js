...
module.exports = {
  ...
  base: '/eLinks_Doc.github.io/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    nav: [
      { text: '首页', link: '/' },
      { text: '文档', link: '/pages/38edee/' ,items: [
        { text: '系统运行', link: '/pages/38edee/' },
      ]},
      {
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'elinks', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
